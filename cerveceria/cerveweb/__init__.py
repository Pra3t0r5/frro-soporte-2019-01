...
FLASH_MSG = {'USU_REG_OK': 'Gracias por registrarte!',
             ...
             'PED_PROD_SUCC': 'Tu pedido ha sido realizado con exito!',
             'PED_STK_ERR': 'Lo sentimos, no disponemos de stock suficiente.',
             'PROD_NOT_FOUND': 'Lo sentimos, el producto ya no existe o la cantidad ingresada es invalida.',
             'PED_PROD_FAIL': 'Lo sentimos. Ha ocurrido un error con tu pedido, reintenta mas tarde.',
